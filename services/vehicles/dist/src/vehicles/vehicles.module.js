...
const vehicles_resolver_1 = require("./vehicles.resolver");
...
exports.VehiclesModule = VehiclesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([vehicle_entity_1.Vehicle, position_entity_1.GpsPosition])],
        providers: [vehicles_service_1.VehiclesService, vehicles_resolver_1.VehiclesResolver],
    })
], VehiclesModule);
