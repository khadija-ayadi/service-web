...
const traffic_resolver_1 = require("./traffic.resolver");
...
exports.TrafficModule = TrafficModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([traffic_zone_entity_1.TrafficZone])],
        providers: [traffic_service_1.TrafficService, traffic_resolver_1.TrafficResolver],
    })
], TrafficModule);
